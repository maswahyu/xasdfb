<a href="{{ $video->url }}" class="post-card post-card--video">
        ...
        <img class="post-card__img post-card__img--video" src="https://img.youtube.com/vi/{{ $video->yt_id }}/hqdefault.jpg"
                alt="">
    ...
    <div class="post-card__title"><span>{{ $video->title }}</span></div>
