...
@section('preload-images')
    @if (!empty($posts) && !empty($posts[0]->thumbnail))
        <link rel="preload" as="image" href="{{ asset($posts[0]->thumbnail) }}" />
    @endif
@endsection
